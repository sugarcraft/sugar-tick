...
| [`x/vcr`](https://github.com/charmbracelet/x/tree/main/vcr) | Record + replay candy-core Program sessions (bug repro / regression / fuzzing) | 🟡 | In progress — `candy-vcr/`. PR1 ships Cassette + Event + JsonlFormat (data layer + JSONL round-trip). Roadmap in [`plans/x-vcr.md`](./plans/x-vcr.md): PR2 Recorder hook in `Program`, PR3 Msg serializers, PR4 Player + ByteAssertion, PR5 ScreenAssertion via candy-vt, PR6 YAML, PR7 CLI + examples. |
