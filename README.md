...
| <img src="media/icons/candy-focus.png" width="48" alt=""> | **[CandyFocus](candy-focus/)** | Focus-ring state machine — ordered focusable regions with Tab/Shift-Tab traversal. Original — no upstream parallel. |
| <img src="media/icons/sugar-gallery.png" width="48" alt="" onerror="this.style.display='none'"> | **[SugarGallery](sugar-gallery/)** | Poster grids & rails for media TUIs — virtualized PosterGrid, Rail carousel, PosterCard. Original — no upstream parallel. |
